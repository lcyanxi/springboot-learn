...
@Slf4j
@Component
public class CanalUserLessonDs0Consumer {

    @CanalListener(databaseName = "ds0",tableName = "pr_user_lesson_3")
    public void consumerUser(String sourceStr, CanalEntry.EventType eventType){
        switch (eventType){
            case INSERT:
                log.info("=========ds0:正在添加文档===========userLesson:{}",sourceStr);
                break;
            case UPDATE:
                log.info("=========ds0:正在修改文档===========userLesson:{}",sourceStr);
                break;
            case DELETE:
